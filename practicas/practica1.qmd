...
subtitle: "<span class='badge rounded-pill text-bg-secondary'>~15 min de lectura</span>"
format:
  html: 
    toc: true
...
::: {layout="[50,50]"}
::: {.column}
![Visualización del [fractal de Mandelbrot](https://processing.org/examples/mandelbrot.html).](../resources/practica1/processing-example.png){#fig-mandelbrot}
:::
::: {.column}
...
![Vista del entorno de desarrollo (derecha) y ventana *pop-up* (izquierda) que redirige a ejemplos disponibles en su página web.](../resources/practica1/ide.png){#fig-ide}
...
::: {layout="[50,50]"}
::: {.column}
![Animación con una resolución de pantalla alta.](../resources/practica1/animation_pixels.webm){#fig-highres}
:::

::: {.column}
![Animación con una resolución de pantalla más baja, donde comienzan a ser visibles los píxeles.](../resources/practica1/animation_pixels_lowerres.webm){#fig-lowres}
:::
:::
...
:::
::: {.column}
![Ilustración de una matriz de píxeles, indicando las coordenadas de algunos de ellos.](../resources/practica1/pixel-matrix.svg){#fig-pixels}
:::
:::
...
![Representación de cómo se interpretan las posiciones en ambos modos para rectángulos y elipses.](../resources/practica1/rect-mode.svg){#fig-rectmodes}
...
::: {.column}
![Imagen representada únicamente con valores de gris.](../resources/practica1/grayscale.svg){#fig-grayscale}
:::
:::
...
::: {layout="[30,70]"}
::: {.column}
![Representación de los colores primarios RGB.](../resources/practica1/primary-colors.png){#fig-rgb}
:::
...
::: {.column}
![Imagen del alienígena Zoog.](../resources/practica1/zoog.png){#fig-zoog}
...
![Analogía del funcionamiento de *Processing*, y el proceso de animación. El resultado final se compone de varias llamadas a `draw`, y en cada llamada, se dibujan múltiples tipos de geometría.](../resources/practica1/disney-animation.svg){#fig-disney-animation}
::: 
...
:::
::: {.column}
![Resultado de añadir 3 pares de brazos a Zoog.](../resources/practica1/zoog-arms.png){#fig-zoog-multiple-arms}
:::
:::
...
![Banner de la página oficial de *Processing*; a la izquierda se muestra el botón de *Download*.](../resources/practica1/web-teaser.png){#fig-installation}
