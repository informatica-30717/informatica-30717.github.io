...
- Posibles mejoras:
  - Cálculo previo del discriminante ($\Delta$), en lugar de calcularlo dos veces.
  - Cálculo previo del denominador ($2a$), en lugar de calcularlo dos veces.
:::
...
- Acciones a realizar:
  ...
  - Si el discriminante es mayor o igual a cero:
    - Aplicar las fórmulas para calcular las dos soluciones.
    - Escribir las soluciones por pantalla.
...
- Acciones a realizar:
  ...
  - Si el discriminante es menor que cero:
    ...
    - Escribir las soluciones por pantalla.
- Mejora para escribir más cómodamente las soluciones:
  - Cálculo previo del denominador ($2a$), en lugar de calcularlo dos veces.
:::
