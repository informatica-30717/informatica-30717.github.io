...
`PanelVisor` coordina la visualización del objeto. La proyección y el recorrido de caras están ahí, pero el cálculo del color está concentrado en `renderer.Shader` y los efectos opcionales en `renderer.PostProcess`.
...
<div id="color-mix-uza">
  <div class="color-mix-stage-uza">
    <div class="color-mix-card-uza">
      ...
      <code id="mix-light-rgb-uza" class="color-mix-code-uza">RGB(255, 64, 64)</code>
    </div>
    ...
    <div class="color-mix-card-uza">
      ...
      <code id="mix-material-rgb-uza" class="color-mix-code-uza">RGB(50, 200, 106)</code>
    </div>
    ...
    <div class="color-mix-card-uza is-result-uza">
      ...
      <div class="color-mix-title-uza">Combinación por canales</div>
      <span id="mix-result-chip-uza" class="color-mix-chip-uza is-result-chip-uza" aria-hidden="true"></span>
      <code id="mix-result-rgb-uza" class="color-mix-code-uza">RGB(50, 50, 27)</code>
    </div>
  </div>
  ...
  <div class="color-mix-formula-uza">
    <div class="color-mix-row-uza">
      ...
      <code id="mix-r-formula-uza">255 × 50 / 255 = 50</code>
    </div>
    <div class="color-mix-row-uza">
      <span class="color-mix-channel-uza is-g-uza">G</span>
      <code id="mix-g-formula-uza">64 × 200 / 255 = 50</code>
    </div>
    <div class="color-mix-row-uza">
      <span class="color-mix-channel-uza is-b-uza">B</span>
      <code id="mix-b-formula-uza">64 × 106 / 255 = 27</code>
    </div>
  </div>

  <div class="color-mix-note-uza">
    <p><strong>Lectura rápida:</strong> si un canal vale 0 en uno de los dos colores, ese canal se anula en el resultado.</p>
    <p>Brillo especular: <span id="mix-spec-chip-uza" class="color-mix-inline-chip-uza" aria-hidden="true"></span> si aparece un brillo, tenderá a seguir el color de la luz.</p>
  </div>
</div>
```
:::
...
A continuación tienes un mapa visual de los componentes difusa y especular en el modelo de iluminación de Phong. No es un diagrama formal, sino una ayuda para entender mejor qué aporta cada término y cómo se combinan.
