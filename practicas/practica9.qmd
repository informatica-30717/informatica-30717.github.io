...
format:
  ...
  pdf:
    output-ext: "pdf"
    filters:
      - ../resources/practica9/filters/pdf-cleanup.lua
execute:
  echo: false
resources:
...
3. Ejecuta la aplicación en **modo depuración**.
...
<!-- Para mantener PDF y web juntos: cada bloque interactivo se oculta en PDF y su alternativa estática va justo debajo. -->
...
La versión HTML incluye una visualización interactiva de `rotacionZ`. En PDF, quédate con este caso fijo para $a=35^\circ$:
...
::: {#fig-practica9-focal layout-ncol=3}
![65 mm: encuadre amplio.](../resources/practica9/images/house_65mm.png){width=100%}

![80 mm: vista de referencia.](../resources/practica9/images/house_80mm.png){width=100%}

![100 mm: encuadre estrecho.](../resources/practica9/images/house_100mm.png){width=100%}
...
::: {#fig-practica9-render-modes layout-ncol=2}
![Malla de alambre.](../resources/practica9/images/wireframe.png){width=100%}

![Ráster con iluminación de Phong.](../resources/practica9/images/house_80mm.png){width=100%}

El mismo objeto en los dos modos de visualización del programa, con focal de 80 mm.
:::
...
La versión HTML incluye un visor 3D interactivo para cambiar `ka`, `kd`, `ks`, `e`, `Ca` y `Cl`. En PDF, la @fig-practica9-phong-materials ofrece una lectura estática de la misma idea: una superficie mate se entiende sobre todo con `kd`, mientras que una superficie brillante o metálica necesita una contribución especular mayor, controlada por `ks` y por el exponente `e`.

::: {#fig-practica9-phong-materials layout-ncol=2}
![Material mate difuso.](../resources/practica9/images/mitsuba_bsdf_diffuse_plain.jpg){width=100%}

![Base difusa plástica.](../resources/practica9/images/mitsuba_bsdf_pplastic_diffuse_component.jpg){width=100%}

![Metal especular.](../resources/practica9/images/mitsuba_bsdf_conductor_gold.jpg){width=100%}

![Brillo plástico.](../resources/practica9/images/mitsuba_bsdf_pplastic_specular_component.jpg){width=100%}

Referencias visuales para interpretar `kd`, `ks` y `e` en el modelo de Phong. Las imágenes proceden de la documentación de Mitsuba 3 sobre materiales BSDF y se usan aquí como referencia cualitativa.
:::
...
::: {#fig-practica9-phong-specular layout-ncol=2}
![Iluminación completa: `ka + kd + ks`.](../resources/practica9/images/full.png){width=100%}

![Sin componente especular: `ka + kd`.](../resources/practica9/images/ka_kd.png){width=100%}

Comparación entre el modelo completo y el mismo caso sin componente especular. El brillo más evidente desaparece al quitar `ks`.
:::

::: {#fig-practica9-phong-ambient layout-ncol=2}
![Ambiente más difusa: `ka + kd`.](../resources/practica9/images/ka_kd.png){width=100%}

![Solo difusa: `kd`.](../resources/practica9/images/kd.png){width=100%}

Comparación entre ambiente más difusa y solo difusa. Sin `ka`, las zonas menos iluminadas quedan mucho más oscuras.
:::
...
La intuición estadística puede verse con un ejemplo muy sencillo: estimar el **área de un círculo de radio 1** generando puntos aleatorios en el cuadrado $[-1,1]^2$.
...
En el renderizado ocurre lo mismo: desde cada píxel se lanzan rayos aleatorios que rebotan entre superficies. Con **pocas muestras por píxel** (*spp*) el resultado es muy ruidoso; con **muchas muestras la imagen se va estabilizando**.

::: {#fig-practica9-spp layout-ncol=2}
![50 spp: pocas muestras por píxel, resultado ruidoso.](../resources/practica9/images/room_50spp.png){width=100%}

![500 spp: más muestras por píxel, resultado más estable.](../resources/practica9/images/room_500spp.png){width=100%}

Comparación de convergencia en Blender Cycles: 50 spp frente a 500 spp, con tiempos orientativos del orden de 3 min y 8 min.
:::
