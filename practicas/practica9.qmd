...
1. Busca en `PanelVisor` la línea:
   ```{.java include="../resources/practica9/snippets/projection-matrix-breakpoint.java"}
   ```
...
```{.java include="../resources/practica9/snippets/disable-camera-inclination.java"}
```
...
```{.java include="../resources/practica9/snippets/print-rotated-vector.java"}
```
:::
