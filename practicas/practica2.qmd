...
subtitle: "<span class='badge rounded-pill text-bg-secondary'>~19 min de lectura</span>"
format:
  html: 
    toc: true
...
![Pantalla de bienvenida.](../resources/practica2/images/init_eclipse.png){#fig-init_eclipse}
...
![Configuración del directorio de trabajo.](../resources/practica2/images/workspace_eclipse.png){#fig-workspace_eclipse}
...
Al abrir *Eclipse*, nos aparecerá una ventana de bienvenida (@fig-welcome_eclipse) con varias opciones, de las cuales cabe destacar las siguientes:

![Pantalla de bienvenida.](../resources/practica2/images/welcome_eclipse.png){#fig-welcome_eclipse}

::: {.card .shadow-sm .mb-3}
::: {.card-body .d-flex .align-items-start}

::: {style="width: 7%; min-width: 50px; flex-shrink: 0;"}
![](../resources/practica2/images/overview.svg){width=100%}
:::
...
::: {style="width: 7%; min-width: 50px; flex-shrink: 0;"}
![](../resources/practica2/images/tutorials.svg){width=100%}
:::
...
::: {style="width: 7%; min-width: 50px; flex-shrink: 0;"}
![](../resources/practica2/images/samples.svg){width=100%}
:::
...
::: {style="width: 7%; min-width: 50px; flex-shrink: 0;"}
![](../resources/practica2/images/new.svg){width=100%}
:::
...
::: {style="width: 7%; min-width: 50px; flex-shrink: 0;"}
![](../resources/practica2/images/workbench.png){width=100%}
:::
...
![Espacio de trabajo de *Eclipse IDE*.](../resources/practica2/images/workbench_eclipse.png){#fig-workbench_eclipse}
...
![Propiedades que debemos configurar al crear un nuevo proyecto.](../resources/practica2/images/new_project.png){#fig-new_project width=70%}
...
![Ejemplo de estructura de una clase Java.](../resources/practica2/images/class_skeleton.png){#fig-class_skeleton}
...
![Creación de una nueva clase de Java en *Eclipse IDE*.](../resources/practica2/images/new_class.png){#fig-new_class width=60%}
...
**Guarda los cambios** que hemos introducido pulsando los iconos con disquetes que hay en la barra de herramientas superior (![](../resources/practica2/images/save.svg){width=1em}![](../resources/practica2/images/save_all.svg){width=1em}), pulsando `Ctrl-S` o bien con `File > Save`.
...
![Proceso de ejecución de un programa.](../resources/practica2/images/file_types.png){#fig-file_types}

--- 

![Compilación de un programa con errores.](../resources/practica2/images/compilation_errors.png){#fig-compilation_errors}
...
Una vez que el programa se ha compilado correctamente, es posible ejecutarlo. Para ello, en el entorno Eclipse se utiliza la opción de menú **`Run > Run as: Java Application`** o bien el icono de **ejecutar** ![](../resources/practica2/images/play.svg){width=1em} en la barra de herramientas superior. Si el programa se ejecuta correctamente, aparecerá una nueva pestaña llamada *Console* en la parte inferior del editor, donde se mostrará la salida del programa.
...
![Depuración de un programa en Eclipse.](../resources/practica2/images/debugging.png){#fig-debug_eclipse}
...
- Utiliza la opción `Run > Debug`, o `Debug` ![](../resources/practica2/images/debug.svg){width=1em}  en la barra de herramientas superior, para lanzar la ejecución en modo depuración de errores. Aparecerá una ventana de *debugger* (depurador) con el estado de todas las variables.
...
![Exportación de proyectos a una carpeta de ficheros.](../resources/practica2/images/export_workspace.png){#fig-export_project}
...
![Importación de proyectos en un *workspace*.](../resources/practica2/images/import_workspace.png){#fig-import_project}
...
![Ejemplo de usos de importación y exportación de bibliotecas.](../resources/practica2/images/import_export_scheme.png){#fig-import_export_scheme}
...
![Creación de una biblioteca .jar a partir de un proyecto.](../resources/practica2/images/jar.png){#fig-create_jar}
...
![Añadir una biblioteca.jar a un proyecto.](../resources/practica2/images/add_jar.png){#fig-add_jar}
...
![Generación de documentación con la herramienta javadoc.](../resources/practica2/images/javadoc.png){#fig-javadoc}
...
![Acceso a la documentación del JDK.](../resources/practica2/images/jdk_doc.png){#fig-jdk_doc}

---

![Acceso a la documentación de la API de Java.](../resources/practica2/images/api_doc.png){#fig-api_doc}
...
![Panel de descarga del instalador de Eclipse.](../resources/practica2/images/eclipse_suite_installation.png){#fig-installer}

---

![Herramientas disponibles en la suite de Eclipse.](../resources/practica2/images/eclipse_suite.png){#fig-suite_tools width=60%}
...
![Instalación de Eclipse para Java, indicando que queremos descargar un JRE.](../resources/practica2/images/jre_installation.png){#fig-jre_installation width=75%}
...
![Instalación de Eclipse para Java, indicando que queremos utilizar un JDK previamente instalado.](../resources/practica2/images/jdk_installation.png){#fig-jdk_installation width=75%}
...
![Paso intermedio de la instalación del JDK. Se muestra la ruta de instalación por defecto, la cual no modificaremos.](../resources/practica2/images/jdk_installation_standalone.png){#fig-jdk_installation2}
...
![Panel de descarga de Eclipse sin instalador.](../resources/practica2/images/eclipse_ide_download.png){#fig-eclipse_download}
...
![Ficheros contenidos en el directorio eclipse, tras descomprimir el fichero .zip descargado de la página oficial de Eclipse.](../resources/practica2/images/filesystem.png){#fig-eclipse_files}
...
![Pregunta de exclusión de Eclipse IDE respecto del sistema antivirus de Windows.](../resources/practica2/images/antivirus.png){#fig-antivirus_eclipse}
