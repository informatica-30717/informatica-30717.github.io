...
```{ojs}
viewof N1 = cleanSlider([10, 50], { value: 29, step: 1, label: "Valor N: " })
```
...
```{ojs}
viewof N2 = cleanSlider([10, 150], { value: 29, step: 1, label: "Valor N: " })
```
...
```{ojs}
//| echo: false
viewof N4 = cleanSlider([10, 150], { value: 51, step: 1, label: "Valor N: " })
```
