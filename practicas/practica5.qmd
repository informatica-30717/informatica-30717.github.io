...
<details>
<summary>Ejemplo de la criba de Eratóstenes sin optimizar</summary>
::: {.card .shadow-sm .mb-4}
::: {.card-body}
...
<details>
<summary>Ejemplo de la criba de Eratóstenes optimizada con la raíz cuadrada</summary>
::: {.card .shadow-sm .mb-4}
::: {.card-body}
...
<details>
<summary>Ejemplo de la criba de Eratóstenes optimizada con un vector de booleanos y solo números impares</summary>
...
//| echo: false
{
  ...
  return html`
    <div style="margin-top:15px;">
      ...
      <div style="margin-top:15px; font-size: 1.1em; height: 1.5em;">
        ${s.type === "prime" ? html`🔎 Probando primo impar <b>${currentPrime}</b>` : s.type === "discard" ? html`❌ ${lastDiscard} es múltiplo impar de <b>${currentPrime}</b>` : html`✅ Criba completada (Tamaño del vector: ${size} posiciones)`}
      </div>
    </div>
  `;
}
