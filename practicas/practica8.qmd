...
:::
::: {.column}
![Esquema general del flujo de trabajo BIM. Fuente: *BIMCloud*.](../resources/practica8/bim_workflow.png){#fig-bim width=100%}
:::
::::
:::
...
![Ciclo de vida de la edificación y papel del modelo BIM. Fuente: *ip21ingenieria*.](../resources/practica8/bim_lifecycle.png){#fig-bim-cycle width=80%}
...
{{< video https://www.youtube.com/watch?v=suNadRnHy-Un title="What Is BIM? by *Autodesk Building Solutions*" >}}
...
- [Duplex.ifc](../resources/practica8/Duplex.ifc), que contiene el modelo BIM original del apartamento dúplex en formato IFC (*Industry Foundation Classes*).
- [Duplex.owl](../resources/practica8/Duplex.owl), que contiene una versión semántica del mismo modelo en lenguaje **OWL** (*Web Ontology Language*).
...
[El fichero `Duplex.owl` se ha generado con la configuración **BOT + PRODUCT + PROPS, Level L1**. Además, se han eliminado manualmente las referencias a dos ontologías externas para simplificar la práctica.]{.aside}
...
{{< video https://drive.google.com/file/d/1eHHxYrJRiQZni_7KKrtRFqu5KEwk9omW title="Introducción a Protégé, de Fernando Bobillo" >}}

::: {.callout-tip}
## Si faltan importaciones

En algunas versiones de *Protégé*, las ontologías importadas se descargan automáticamente desde Internet. En otras, tendremos que resolver manualmente las importaciones. En este último caso, en `Active ontology > Ontology imports` pinchamos en el botón `+` para añadir los ficheros [beo.owl](../resources/practica8/beo.owl) y [⬇️ bot.owl](../resources/practica8/bot.owl).
:::
