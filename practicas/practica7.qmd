...
![Instalando el complemento RhinoBanana.](../resources/practica7/rhino_banana_install.png){#fig-install-rhino-banana width=70%}
...
![Introduciendo "Grasshopper" en la barra de comandos de *Rhino* 8.](../resources/practica7/commands.png){#fig-command-line width=50%}
...
:::
::: {.column}
![](../resources/practica7/teacups.jpg)
:::
:::
...
![Compartiendo la pantalla entre *Rhino* y *Grasshopper*.](../resources/practica7/split_screen.png){#fig-split-screen}

![Opciones de visualización en *Rhino*.](../resources/practica7/maximizar_renderizado.png){#fig-maximizar-renderizado width=80%}
...
:::
::: {.column}
![Esquema de vasija con escala en el polígono superior.](../resources/practica7/vase_scale.png){#fig-vase-scale}
:::
::::

![Definición del polígono superior de la vasija, con el nodo de escala.](../resources/practica7/scale_move_polygon.png){#fig-vasija-grafo}
...
![Definición de Grasshopper para generar un patrón Voronoi en la vasija.](../resources/practica7/voronoi_graph.png){#fig-voronoi-grafo}
...
Una vez modeladas la taza y la vasija, podemos generar una imagen final más rica visualmente mediante un modelo de difusión. La idea no es modificar la geometría base, sino utilizar una vista del modelo como referencia para añadir materiales, iluminación, contexto y detalles que no estaban presentes en la escena original.
...
![Interfaz de RhinoBanana.](../resources/practica7/rhino_banana.png){#fig-rhino-banana width=60%}
...
- `diffusion.png`, una imagen generada con un modelo de difusión a partir de una vista de la vasija.
