...
\definecolor{p8BannerInk}{HTML}{010E1A}
\definecolor{p8BannerMuted}{HTML}{31485C}
  ...
  \begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture,overlay]
      ...
      \node[anchor=north west, inner sep=0pt] at (current page.north west) {%
        \includegraphics[width=\paperwidth]{\practicaPdfCoverImage}%
      };
      \fill[white, opacity=0.82] ([yshift=-23mm]current page.north west) rectangle ([yshift=-78mm]current page.north east);
      \draw[p8BannerInk, line width=0.5pt] ([xshift=24mm,yshift=-122mm]current page.north west) -- ([xshift=-24mm,yshift=-122mm]current page.north east);
      \node[anchor=north west, align=left, text=p8BannerInk] at ([xshift=24mm,yshift=-29mm]current page.north west) {%
        {\sffamily\small\bfseries INFORMÁTICA (30717)}\\[6mm]
        {\sffamily\bfseries\fontsize{30}{35}\selectfont \@title}\\[3mm]
        {\sffamily\Large\textcolor{p8BannerMuted}{Grado en Estudios en Arquitectura}}%
      };
      \node[anchor=south east, inner sep=0pt] at ([xshift=-24mm,yshift=24mm]current page.south east) {%
        \includegraphics[width=34mm]{\practicaPdfLogo}%
      };
      \node[anchor=south west, align=left, text=p8BannerMuted] at ([xshift=24mm,yshift=34mm]current page.south west) {%
        {\sffamily\large\textcolor{uzaBlueDark}{Universidad de Zaragoza}}\\[2mm]
        {\sffamily\small Material de prácticas del curso 2025--2026}%
      };
    \end{tikzpicture}
    \null
  \end{titlepage}
...
\emph{Visor interactivo de nubes de puntos disponible en la versión
HTML.}
