...
::: {.column-margin}
![[Ejemplos de catenarias en arquitectura.](https://apuntesdearquitecturadigital.blogspot.com/2019/10/el-arquitecto-gaudi-y-la-catenaria-las.html)](../resources/practica4/images/ejemplos_catenarias.jpg){#fig-ejemplos-catenarias}
:::
...
::: {.column-margin}
![Ejemplo de uso de la macro `EvaluarF`.](../resources/practica4/images/ejemplo_evaluarf.png){#fig-ejemplo-evaluarf}
:::
...
![Error indicando que la función `EvaluarF` no está definida.](../resources/practica4/images/error_evaluarf.png){width="50%" #fig-error-evaluarf}
:::
...
![Implementación de la función EvaluarF.](../resources/practica4/images/solucion-evaluarf.png){#fig-solucion-evaluarf}
</details>-->
...
<details>
<summary>💡 Solución</summary>
![función: EvaluarF](../resources/practica4/images/resultado_evaluarf.png){#fig-resultado_evaluarf}
</details>
