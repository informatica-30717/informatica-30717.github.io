...
::: {.g-col-4}
![Dibuja fotogramas en bucle.](../resources/lesson1/processing-draw.png){#fig-processing-draw}
:::

::: {.g-col-4}
![Fin del programa y de la animación.](../resources/lesson1/processing-finished.png){#fig-processing-finished}
:::
:::
...
:::
::: {.column}
![Resultado de añadir 3 pares de brazos a Zoog.](../resources/lesson1/zoog-arms.png){#fig-zoog-multiple-arms}
:::
:::
