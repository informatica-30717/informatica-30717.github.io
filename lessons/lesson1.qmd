...
::: {layout="[50,50]"}
::: {.column}
![Animación con una resolución de pantalla alta.](../resources/lesson1/animation_pixels.webm){#fig-environment}
:::
::: {.column}
![Animación con una resolución de pantalla baja, mostrando píxeles.](../resources/lesson1/animation_pixels_lowerres.webm){#fig-environment}
:::
:::
...
::: {.callout-note}
## 🧪 Ejercicio 8 - Simula una forma geométrica

Trata de obtener algo parecido a la figura que se muestra a la derecha.

![](../resources/lesson1/render.png){width="30%"}
:::
...
### Programas dinámicos: setup y draw
