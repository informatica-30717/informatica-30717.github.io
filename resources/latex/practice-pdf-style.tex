...
\providecommand{\practicaPdfLogo}{../resources/unizar.png}
\newlength{\PracticeCoverContentWidth}
\newlength{\PracticeCoverMediaWidth}
\newlength{\PracticeCoverBandHeight}
\setlength{\PracticeCoverContentWidth}{0.94\textwidth}
\setlength{\PracticeCoverMediaWidth}{\textwidth}
\setlength{\PracticeCoverBandHeight}{88mm}
...
\newtcolorbox{PracticeTipBox}[1]{%
  ...
  fonttitle=\sffamily\bfseries,
  title={#1},
  borderline west={1.4pt}{0pt}{uzaTip},
  left=2mm,
  right=2mm,
  top=1.4mm,
  bottom=1.4mm,
...
\newcommand{\PracticeCenteredImage}[2][]{%
  \par\noindent{%
    \centering
    \pandocbounded{\includegraphics[#1]{#2}}%
    \par
  }%
}
...
\renewcommand{\maketitle}{%
  \begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture,overlay]
      \fill[uzaCyan] (current page.north west) rectangle ([yshift=-\PracticeCoverBandHeight]current page.north east);
      \fill[uzaBlue] (current page.north west) rectangle ([xshift=7mm]current page.south west);
      \node[anchor=south east, inner sep=0pt] at ([xshift=-24mm,yshift=22mm]current page.south east) {%
    ...
    \vspace{2.5mm}
    \noindent
    \begin{minipage}{\PracticeCoverContentWidth}
      \raggedright
      \sffamily\bfseries\fontsize{30}{35}\selectfont
      \color{uzaInk}\@title\par
    \end{minipage}\par
    \vspace{3mm}
    {\sffamily\Large\textcolor{uzaMuted}{Grado en Estudios en Arquitectura}}\par
    \vspace{14mm}
    \noindent\makebox[0pt][l]{\color{uzaBlue}\rule{\PracticeCoverMediaWidth}{0.6pt}}\par
    \if\relax\detokenize\expandafter{\practicaPdfCoverImage}\relax
    \else
      \vspace{5mm}
      \noindent\makebox[0pt][l]{\includegraphics[width=\PracticeCoverMediaWidth,height=78mm,keepaspectratio]{\practicaPdfCoverImage}}\par
    \fi
    \vfill
...
\AtBeginEnvironment{figure*}{\centering}
\AtBeginEnvironment{subfigure}{\centering}
